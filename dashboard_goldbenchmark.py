"""
dashboard_goldbenchmark.py -- GoldBenchmark A.I. dashboard (Benchmark Desk)
Port 5023. Single-instrument (Gold XAU/USD). Prominent WITH/AGAINST switch (live
...
HTML = """<!DOCTYPE html>
<html><head><meta charset="utf-8"><title>GoldBenchmark A.I.</title>
<style>
...
<header>
  <div class="brand">GOLD<span style="color:#fff">BENCHMARK</span> A.I.
    <small>__VER__ &middot; port 5023 &middot; Gold XAU/USD &middot; Lancelot + 3-TF SSL + switch</small></div>
  <div class="nav">
...
def api_health():
    return jsonify({"status": "ok", "system": "GoldBenchmark",
                    "time": datetime.now(timezone.utc).isoformat()})


if __name__ == "__main__":
    print("GoldBenchmark dashboard -> http://localhost:%d" % PORT)
